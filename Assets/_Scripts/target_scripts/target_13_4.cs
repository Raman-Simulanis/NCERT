...
namespace Vuforia
{
    ...
    /// </summary>
	public class target_13_4 : MonoBehaviour,
                                                ITrackableEventHandler
    {
        ...
        void Start()
        {
           ...
           // toggleVRButton1.gameObject.SetActive(false);
        ...
        private void OnTrackingLost()
        {
			try
			{
				...
				fbx.gameObject.transform.localScale = new Vector3 (2.226633f, 2.226633f, 2.226633f);
