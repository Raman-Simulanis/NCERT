...
namespace Vuforia
{
    ...
    /// </summary>
	public class target_13_5 : MonoBehaviour,
                                                ITrackableEventHandler
    {
        ...
        private void OnTrackingLost()
        {
			try
			{
				...
				fbx.gameObject.transform.localPosition = new Vector3 (0.148f,0f, 0f);
				fbx.gameObject.transform.localScale = new Vector3 (3.027749f, 3.027749f, 3.027749f);
