...
namespace Vuforia
{
    ...
    /// </summary>
	public class target_13_19 : MonoBehaviour,
                                                ITrackableEventHandler
    {
        ...
        private void OnTrackingLost()
        {
			try
			{
				...
				fbx.gameObject.transform.localScale = new Vector3 (-1.233314f, 1.233314f, 1.233314f);
				fbx.gameObject.transform.localRotation = Quaternion.Euler(0.1947f, 2.7085f, 1.5677f);
			}
			catch(System.Exception e)
			{
				print ("Something Wrong with Your Device");
