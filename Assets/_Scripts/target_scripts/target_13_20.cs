...
namespace Vuforia
{
    ...
    /// </summary>
	public class target_13_20 : MonoBehaviour,
                                                ITrackableEventHandler
    {
        ...
        private void OnTrackingLost()
        {
			try
			{
				...
				fbx.gameObject.transform.localScale = new Vector3 (0.6759121f, 0.6759121f, 0.6759121f);
				fbx.gameObject.transform.localRotation = Quaternion.Euler(-90f, -180f, 0f);
			}
			catch(System.Exception e)
			{
				print ("Something Wrong with Your Device");
