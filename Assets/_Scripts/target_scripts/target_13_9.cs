...
namespace Vuforia
{
    ...
    /// </summary>
	public class target_13_9 : MonoBehaviour,
                                                ITrackableEventHandler
    {
        ...
        private void OnTrackingLost()
        {
			try
			{
				...
				fbx.gameObject.transform.localPosition = new Vector3 (-0.122f,-0.000f, 0f);
				fbx.gameObject.transform.localScale = new Vector3 (4.954538f, 4.954538f, 4.954538f);
